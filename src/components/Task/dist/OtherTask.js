...
function CommonTask(_a) {
    ...
    var otherTask = tasks === null || tasks === void 0 ? void 0 : tasks.filter(function (task) { return task.type === 1; });
    var Row = function (_a) {
            ...
            react_2["default"].createElement("div", { key: key, style: style, className: "post" },
                react_2["default"].createElement(react_2["default"].Fragment, null,
                    react_2["default"].createElement(react_1.Flex, { justifyContent: "space-between", alignItems: "center", key: key },
                        react_2["default"].createElement(react_1.Button, { colorScheme: "blue", size: "sm", onClick: function () { return handleClickEdit(otherTask[index]); } }, "Edit"),
                        react_2["default"].createElement(react_1.Text, { bg: 'none', mr: 'auto', ml: '10px' }, otherTask[index].name),
                        react_2["default"].createElement(react_1.Box, null,
                            otherTask[index].isDeleted ? (react_2["default"].createElement(react_1.Button, { colorScheme: "orange", size: "sm", onClick: function () {
                                    dispatch(AlertReducer_1.storeId(otherTask[index]));
                                    onOpenUn();
                                } }, "Unarchive")) : (react_2["default"].createElement(react_1.Button, { colorScheme: "orange", size: "sm", onClick: function () {
                                    dispatch(AlertReducer_1.storeId(otherTask[index]));
                                    onOpenAr();
                                } }, "Archive")),
                            react_2["default"].createElement(react_1.Button, { colorScheme: "red", size: "sm", ml: 2, isDisabled: !otherTask[index].isDeleted, onClick: function () {
                                    dispatch(AlertReducer_1.storeId(otherTask[index]));
                                    onOpenDelete();
                                } }, "Delete"))),
    ...
    return (react_2["default"].createElement(react_1.Box, { height: '550px' },
        react_2["default"].createElement(react_1.Heading, { fontSize: 30, my: 5 },
            "Other Tasks (", tasks === null || tasks === void 0 ? void 0 :
            tasks.filter(function (task) { return task.type === 1; }).length,
            ")"),
        react_2["default"].createElement(react_virtualized_auto_sizer_1["default"], null, function (_a) {
            var height = _a.height, width = _a.width;
            return (react_2["default"].createElement(react_window_1.FixedSizeList, { height: 500, width: width, itemCount: otherTask === null || otherTask === void 0 ? void 0 : otherTask.length, itemSize: 50 }, Row));
        }),
        react_2["default"].createElement(react_1.Box, { maxHeight: '60vh', overflowY: "scroll" }),
